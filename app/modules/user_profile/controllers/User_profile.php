...
class User_profile extends CI_Controller {
	...
	public function update()
    {
        ...
        if ( ! $this->upload->do_upload()){
            $this->session->set_flashdata('err_', $this->upload->display_errors());
            ...
            if ($this->input->post('password') != "")
            {
                ...
                {
                    $this->session->set_flashdata('err_', 'Password dan Re-password tidak sesuai');
                    redirect('/user_profile','refresh');
                }else{
            ...
            $this->session->set_flashdata('success_', 'Sukses update');
            redirect('/user_profile','refresh');
        }
      }else{
            $id = $this->input->post('id', TRUE);
