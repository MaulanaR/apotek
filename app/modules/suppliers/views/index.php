                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label ">Alamat</label>
                                ...
                                <textarea name="alamat" class="form-control" placeholder="Alamat" maxlength="200"></textarea>
                                <span class="help-block"></span>
                        ...
                        <div class="form-group">
                            <label class="control-label ">Kode POS</label>
                                ...
                                <<input type="number" name="kodepos" class="form-control" placeholder="Nomor Telepon">
                                <span class="help-block"></span>
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.data.ms_id);
            $('[name="name"]').val(data.nama);
            $('[name="alamat"]').val(data.data.ms_alamat);
            $('[name="telp"]').val(data.data.ms_telp);
            $('[name="kodepos"]').val(data.data.ms_kodepos);
...
/*function refresh_menu_list() {
     $.ajax({
          type:"GET",
          url: "<?php //echo base_url('suppliers/refresh_menu_list/');?>",
          dataType:"JSON",
          beforeSend: function() 
          { 
           },
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('suppliers/ajax_delete')?>/",
            type: "POST",
            data:{'id' : id},
            dataType: "JSON",
            success: function(data)
