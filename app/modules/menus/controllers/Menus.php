...
class Menus extends CI_Controller {
	...
	public function ajax_list()
    {
        ...
        foreach ($list as $person) {
        	...
        	{
        		$row[] = '<a class="btn btn-sm btn-outline-primary" href="javascript:void(0)" title="Edit" onclick="edit_person('."'".$person->menu_id."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                  <a class="btn btn-sm btn-outline-danger" href="javascript:void(0)" title="Hapus" onclick="delete_person('."'".$person->menu_id."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
        	}
        	...
        	{
        		$row[] = '<a class="btn btn-sm btn-outline-danger" href="javascript:void(0)" title="Hapus" onclick="delete_person('."'".$person->menu_id."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
        	}
