...
class Group extends CI_Controller {
	...
	public function ajax_list()
    {
        ...
        foreach ($list as $person) {
        	...
        	{
        		$row[] = '<a class="btn btn-sm btn-outline-primary" href="javascript:void(0)" data-toggle="tooltip" title="Edit Group" onclick="edit_person('."'".$person->id."'".')"><i class="fa fa-pencil-alt"></i></a>';

        		$row[] = '<a class="btn btn-sm btn-outline-warning" href="javascript:void(0)" data-toggle="tooltip" title="Edit Hak Akses" onclick="openform('."'".$person->id."'".')"><i class="fa fa-server"></i></a>';

        		$row[] = '<a class="btn btn-sm btn-outline-danger" href="javascript:void(0)" data-toggle="tooltip" title="Hapus" onclick="delete_person('."'".$person->id."'".')"><i class="fa fa-trash"></i></a>';

        	}elseif($this->privilege['can_edit'] == 0 && $this->privilege['can_delete'] == 1)
        	{
        		$row[] ='';
        		$row[] ='';
        		$row[] = '<a class="btn btn-sm btn-danger" href="javascript:void(0)" data-toggle="tooltip" title="Hapus" onclick="delete_person('."'".$person->id."'".')"><i class="fa fa-trash"></i></a>';

        	}elseif($this->privilege['can_edit'] == 1 && $this->privilege['can_delete'] == 0)
        	{
        		$row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" data-toggle="tooltip" title="Edit Group" onclick="edit_person('."'".$person->id."'".')"><i class="fa fa-pencil-alt"></i></a>';

        		$row[] = '<a class="btn btn-sm btn-warning" href="javascript:void(0)" data-toggle="tooltip" title="Edit Hak Akses" onclick="openform('."'".$person->id."'".')"><i class="fa fa-server"></i></a>';
