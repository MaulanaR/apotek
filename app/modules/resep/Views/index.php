    ...
    <div class="container-fluid">
      ...
      <section class="content">
        <div class="callout callout-info">
          <p>Berikut adalah daftar resep yang disimpan oleh sistem.</p>
        </div>
          <div class="card">
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('resep/ajax_list')?>",
            "type": "POST"
        },
...
function detail(a){
  window.location = '<?php echo base_url('resep/salinan_resep/'); ?>' + a;
}
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('resep/ajax_delete')?>/",
            type: "POST",
            data:{'id' : id},
            dataType: "JSON",
